...
// Partner logs everything including successful requests
...
// Controllers
app.use("/", require("./controllers/partner-controller.js"));
  ...
  return response.format({
    ...
    html: () => {
      if (error.statusCode == 401) {
        ...
        request.flashRedirect("error", error.message, "/partner");
      }
      else {
